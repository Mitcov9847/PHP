...
1. Установите [XAMPP](https://www.apachefriends.org/index.html).
2. Запустите модули **Apache** и **MySQL** через панель управления XAMPP.
3. Склонируйте репозиторий в папку `C:\xampp\htdocs`:
...
Создайте базу данных (например, game_store)

Импортируйте файл sql/init.sql из проекта
...
Копировать
Редактировать
http://localhost/your-repo-name/public/index.php
🔐 Основной функционал
👤 Аутентификация
...
/sql/init.sql — скрипт создания базы данных
