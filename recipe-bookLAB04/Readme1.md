...
recipe-book/
│
├── index.php                        # Главная страница с 2 последними рецептами
├── recipe/
│   ├── create.php                   # Форма создания нового рецепта
│   └── index.php                    # Страница со всеми рецептами с пагинацией
│
├── storage/
│   └── recipes.txt                  # Хранилище рецептов (JSON построчно)
│
└── assets/                          # (при необходимости) стили, изображения и т.д.
```
...
**Скриншот**:  
_🔽 Вставьте сюда скриншот главной страницы_  
